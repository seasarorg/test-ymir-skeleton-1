...
public class ConfirmViewDtoBase
...
<#if table.columns?size != 0> 
    public ConfirmViewDtoBase()
    {
    }
</#if>

    public ConfirmViewDtoBase(<#list table.columns as column>String ${column.name}<#if column_has_next>, </#if></#list>)
    {
<#list table.columns as column>
